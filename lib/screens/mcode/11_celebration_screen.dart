        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              _buildBulletPoint('• Openness: High'),
              _buildBulletPoint('• Conscientiousness: Medium'),
              _buildBulletPoint('• Extraversion: High'),
              _buildBulletPoint('• Agreeableness: Low'),
              _buildBulletPoint('• Neuroticism: Low'),
              const SizedBox(height: 16),
              Text(
                'Приоритетные сферы:',
                style: AppTextStyles.body.copyWith(
